...
public class ExportacaoExcel extends JFrame {
	...
	public ExportacaoExcel() {
		...
		lblExportaoDeDados.setFont(new Font("Arial", Font.PLAIN, 14));
		lblExportaoDeDados.setBounds(83, 11, 277, 15);
		...
		textField_1.setBounds(162, 58, 98, 20);
		contentPane.add(textField_1);
		textField_1.setColumns(10);
		
		JLabel lblDataaaaammdd = new JLabel("Data: (AAAA-MM-DD):");
		lblDataaaaammdd.setFont(new Font("Arial", Font.PLAIN, 14));
		lblDataaaaammdd.setBounds(12, 61, 140, 14);
