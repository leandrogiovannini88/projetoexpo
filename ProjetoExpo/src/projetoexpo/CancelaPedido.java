...
public class CancelaPedido extends JFrame {
	...
	public CancelaPedido(int idPedido, TelaPrincipal telaPrincipal) {
		...
		lblDesejaCancelarO.setFont(new Font("Arial", Font.PLAIN, 15));
		lblDesejaCancelarO.setBounds(20, 36, 349, 24);
...
//						pedido.deletarPedido(conn, idPedido);
		...
		btnSim.setBounds(20, 104, 241, 85);
